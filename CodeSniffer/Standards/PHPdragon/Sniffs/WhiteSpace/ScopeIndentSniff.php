 ...
 */
class PHPdragon_Sniffs_WhiteSpace_ScopeIndentSniff implements PHP_CodeSniffer_Sniff {
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr) {
        ...
        for ($i = ($stackPtr + 1); $i < $phpcsFile->numTokens; $i++) {
            ...
            if ($checkToken !== null && isset(PHP_CodeSniffer_Tokens::$methodPrefixes[$tokens[$checkToken]['code']]) === true && $tokens[($checkToken + 1)]['code'] !== T_DOUBLE_COLON
            ) {
                $exact = true;
            }
