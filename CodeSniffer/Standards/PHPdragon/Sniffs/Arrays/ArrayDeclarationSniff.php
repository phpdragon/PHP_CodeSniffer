 ...
 */
class PHPdragon_Sniffs_Arrays_ArrayDeclarationSniff implements PHP_CodeSniffer_Sniff {
    ...
    public function processMultiLineArray(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $arrayStart, $arrayEnd) {
        ...
        for ($nextToken = ($stackPtr + 1); $nextToken < $arrayEnd; $nextToken++) {
            ...
            if ($tokens[$nextToken]['code'] === T_COMMA) {
                ...
                if ($keyUsed === false) {
                    ...
                    $valueContent = $phpcsFile->findNext(
                        PHP_CodeSniffer_Tokens::$emptyTokens, ($lastToken + 1), $nextToken, true
                    );
            ...
            if ($tokens[$nextToken]['code'] === T_DOUBLE_ARROW) {
                ...
                $nextContent = $phpcsFile->findNext(
                    PHP_CodeSniffer_Tokens::$emptyTokens, ($nextToken + 1), $arrayEnd, true
                );
        ...
        if ($keyUsed === false && empty($indices) === false) {
            ...
            $trailingContent = $phpcsFile->findPrevious(
                PHP_CodeSniffer_Tokens::$emptyTokens, ($arrayEnd - 1), $lastIndex, true
            );
