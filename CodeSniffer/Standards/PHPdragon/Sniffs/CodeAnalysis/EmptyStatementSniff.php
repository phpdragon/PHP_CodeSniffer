 ...
 */
class PHPdragon_Sniffs_CodeAnalysis_EmptyStatementSniff implements PHP_CodeSniffer_Sniff {
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr) {
        ...
        $next = $phpcsFile->findNext(
            PHP_CodeSniffer_Tokens::$emptyTokens, ($token['scope_opener'] + 1), ($token['scope_closer'] - 1), true
        );
